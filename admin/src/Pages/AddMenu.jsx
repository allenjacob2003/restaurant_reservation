     ...
     <form onSubmit={onSubmitHandler} className='flex flex-col items-start  gap-1' >
      ...
      <div className='flex  flex-wrap gap-4 w-full'>
        ...
        <div>
          ...
          <input value={price} onChange={(e)=> setPrice(e.target.value)} type="number" placeholder='40' className='w-full max-w-[120px] p-4 border border-gray-300 rounded' required/>
        </div>
